...
<body>
    ...
    <div class="topnav">
        ...
        <?php
            ...
            $res = "SELECT * FROM `restaurant` WHERE `Type_ID` = '3' limit {$start},{$perpage}";
            ...
            {
               // แก้ชื่อประเภท *******************************************************************************************************
                if($obj['Type_Name_Restaurant'] == 'อาหารตามสั่ง')
                {
                    $type_id = $obj['Type_ID'];
                }
            }
    ...
    <div class="tpaper">
    <?php // แก้ชื่อประเภท *******************************************************************************************************?>
    <h1><i style='font-size:40px' class='fas'>&#xf02b;</i> อาหารตามสั่ง</h1>
    <?php

...
<body>
    ...
    <div class="topnav">
        ...
        <?php
            ...
            $res = "SELECT * FROM `restaurant` WHERE `Type_ID` = '1' limit {$start},{$perpage}";
            ...
            {
               // แก้ชื่อประเภท *******************************************************************************************************
                if($obj['Type_Name_Restaurant'] == 'อาหารญี่ปุ่น')
                {
                    $type_id = $obj['Type_ID'];
                }
            }
    ...
    <div class="tpaper">
    <?php // แก้ชื่อประเภท *******************************************************************************************************?>
    <h1><i style='font-size:40px' class='fas'>&#xf02b;</i> อาหารญี่ปุ่น</h1>
    <?php

...
<body>
    ...
    <?php // แก้ชื่อเป็นชื่อร้าน *******************************************************************************************************?>
        ...
        //$sql = 'SELECT * FROM `menu_foods`';
        $sqcom = "SELECT * FROM `menu_foods_on_restaurant_composite_entity` WHERE Restaurant_ID = '702' limit {$start},{$perpage}";
    ...
    <?php
         $sql2 = "SELECT * FROM `menu_foods_on_restaurant_composite_entity` WHERE Restaurant_ID = '702'";
        ...
        <nav style = " font-family: 'Kanit', sans-serif;
                  font-size: 22px;
                  font-weight: 700;">
         <a href="http://localhost/food/menu/702" aria-label="Previous">
         <span aria-hidden="true" >First</span>
         </a>
         
         <?php 
         for($i=1;$i<=$total_page;$i++){ ?>
         <a href="http://localhost/food/menu/702?page=<?php echo $i; ?>"><?php echo $i; ?></a>
         <?php } ?>
         <a href="http://localhost/food/menu/702?page=<?php echo $total_page;?>" aria-label="Next">

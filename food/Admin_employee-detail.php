...
<body>
    ...
    <?php
     require('connect.php');
    $i=1;
    $employee_detail_sqli = "SELECT * FROM employee";
    ...
    ?>
        <tr>
            ...
            <td align="center"><a href="Admin_delete-employee.php?Employee_ID=<?php echo $employee_detail_result["Employee_ID"];?>"><i class='fas fa-trash-alt' style='font-size:32px;color:red'></i></a></td>
        </tr>
    <?php
    $i=$i+1;
    }

...
<body>
    ...
    <div class="topnav">
        ...
        <a href="cus_his.html">ประวัติการสั่ง</a>
        <a href="">บัญชี</a>
    </div>
    ...
    <div class="log1">
        <div class="container" style="border:3px solid rgb(245, 217, 93)">
            <label for="idcard"><b><i style='font-size:24px' class='far'>&#xf2c2;</i> เลขที่บัตรประชาชน</b></label>
            <input type="text" placeholder="Enter ID card number" name="idcard" required>
            <label for="car"><b><i style='font-size:24px' class='far'>&#xf2c2;</i> ยี่ห้อรถ</b></label>
            <input type="text" placeholder="Enter car brand" name="carbrand" required>
            <label for="carid"><b><i style='font-size:24px' class='far'>&#xf2c2;</i> ทะเบียนรถ</b></label>
            <input type="text" placeholder="Enter license plate" name="carid" required>
            <br>

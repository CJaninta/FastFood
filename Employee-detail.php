...
<?php
	...
	else if($_SESSION['Status'] == "User" or $_SESSION['First_name'] =="admin")
    {
        ?>
        <script>
    ...
    <div class="topnav">
        ...
        <div class="logtext" style = "color:rgb(29, 24, 78);">
           ...
           <?php
              ...
              echo ("Employee : ").$_SESSION['First_name'];
           ?>
        </div>
        </form>
    </div>
    ...
    <div class="log">
        ...
        <div class="log1">
            ...
            <div class="container" style="border:3px solid rgb(245, 217, 93)">
                ...
                <label for="idcard"><b><i style='font-size:24px' class='far'>&#xf2c2;</i>
                        ยี่ห้อรถ : <?php echo $_SESSION["Brand_Motorcycle"];?></b></label><br><br>
                <label for="idcard"><b><i style='font-size:24px' class='far'>&#xf2c2;</i>
                       ป้ายทะเบียนรถ : <?php echo $_SESSION["License_plate"];?></b></label><br><br>
            </div>
